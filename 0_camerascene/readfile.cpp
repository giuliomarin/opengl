          ...
          if (numused == numLights) { // No more Lights
            ...
            if (validinput) {
              ...
              // Those arrays can then be used in display too.
							...
							// position
							memcpy(&lightposn[4 * numused], &values[0], 4 * sizeof(GLfloat));
							// color
        ...
        // Note that no transforms/stacks are applied to the colors.
          ...
          if (validinput) {
            ...
            // Set eyeinit upinit center fovy in variables.h
						...
						vec3 upNoNorm = vec3(values[6], values[7], values[8]);
						upinit = Transform::upvector(upNoNorm, center - eyeinit);
						fovy = values[9];
          }
        }
        ...
        // Also look at demo.txt to get a sense of why things are done this way.
          ...
          if (validinput) {
            ...
            // Also keep in mind what order your matrix is!
						...
						mat3 R3 = Transform::rotate(values[3], glm::normalize(vec3(values[0], values[1], values[2])));
						mat4 R(1.0);
						for (int c = 0; c < 3; c++)
							for (int r = 0; r < 3; r++)
								R[c][r] = R3[c][r];
